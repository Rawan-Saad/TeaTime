      ...
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              padding: EdgeInsets.only(left: 36,top: 10,right: 36,bottom: 20),
              child: Text(
                'Iced lemon tea is a refreshing beverage. It is made with freshly brewed black tea and freshly squeezed lemon juice.',
                style: TextStyle(
                  fontStyle: FontStyle.normal,
                  fontSize:  25,
                  fontWeight:  FontWeight.bold,
